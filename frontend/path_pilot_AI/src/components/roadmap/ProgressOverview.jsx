function ProgressOverview({ currentPhase, phaseCount, progress }) {
  return (
    <section className="roadmap-progress" aria-label="Roadmap progress">
      ...
      <p>{progress.percentage === 100 ? 'Roadmap complete' : `Current phase: ${currentPhase} of ${phaseCount}`} <small>{progress.completedCount} of {progress.totalCount} items completed</small></p>
    </section>
  )
}
