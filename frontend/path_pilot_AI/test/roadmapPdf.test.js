...
test('PDF model includes cover, summary, phases, projects, and per-phase resources', () => {
  ...
  const roadmap = {
    ...
    coachSummary: { strengths: 'Clear goal.', biggestChallenge: 'Consistency.', recommendedStrategy: 'Balanced', nextAdvice: 'Begin with SQL.' },
  ...
  assert.equal(model.summary.coach.recommendedStrategy, 'Balanced')
